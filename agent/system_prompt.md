...
4. **Формат completed.md**: При переносе задачи из todo.md в completed.md добавляй только заголовок задачи и ссылку на файл задачи. Все детали реализации, описание, план и чеклист остаются в файле задачи в папке `tasks/`. Формат: `- [x] [Название задачи](tasks/task-name.md) ✅`
