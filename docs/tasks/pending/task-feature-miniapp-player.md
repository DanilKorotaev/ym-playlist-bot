...
**Идея:** После завершения воспроизведения плейлиста автоматически переключаться на "Мою волну" (радио на основе плейлиста). Если в плейлист добавили новые треки, они воспроизводятся первыми, затем снова "Моя волна".

**Статус:** 🔍 Вынесено в отдельную задачу для детального исследования

**Связанная задача:** [`task-feature-miniapp-radio-continuation.md`](task-feature-miniapp-radio-continuation.md)

**Краткое описание:**
- Автоматическое переключение на "Мою волну" после завершения плейлиста
- Интеграция с существующей логикой обновления очереди
- Требуется исследование API Яндекс.Музыки для работы с радио

**Подробности:** См. [`task-feature-miniapp-radio-continuation.md`](task-feature-miniapp-radio-continuation.md)
