...
- [x] [Прикрепление картинки из плейлиста ЯМ в сообщение с инфо о плейлисте](tasks/completed/task-ux-playlist-cover.md) 
- [x] [Улучшить отображение списка треков (пагинация)](tasks/completed/task-ux-pagination.md) 

## Обработка ошибок

- [x] Улучшить обработку ошибок (более информативные сообщения)
- [x] [Исправить удаление треков](tasks/completed/task-bug-delete-tracks.md)
- [x] [Улучшение обработки ошибок при создании и редактировании плейлистов](tasks/completed/task-tech-playlist-error-handling.md) 
- [x] [Исправление парсинга ссылок на плейлисты и получения плейлистов по ссылке](tasks/completed/task-bug-playlist-link-parsing.md) 
