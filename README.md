...
- `/create_playlist [название]` - создать новый плейлист (интерактивный режим)
...
- `/playlist_info [номер]` - информация о плейлисте (с ссылкой на Яндекс.Музыку)
- `/delete_track [номер]` - удалить трек из плейлиста (интерактивный режим)

### Управление плейлистами
- `/set_token [токен]` - установить свой токен Яндекс.Музыки (интерактивный режим)
- `/edit_name [новое название]` - изменить название плейлиста (интерактивный режим, только для создателя)
...
- Создания плейлиста (если не указано название)
- Установки токена (если не указан токен)
